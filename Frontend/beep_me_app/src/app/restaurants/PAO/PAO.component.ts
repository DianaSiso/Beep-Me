...
export class PAOComponent implements OnInit {
  ...
  constructor(private httpClient:HttpClient){}
   ...
   fetchRestStamps():void{
    this.httpClient.get<any>('http://deti-engsoft-02.ua.pt:8080//orders/restaurant?rest_id=38').subscribe(res=>
    {
  ...
  fetchTest():void{ //Mudar rest_id //
    this.httpClient.get<any>('http://deti-engsoft-02.ua.pt:8080//orders/restaurant?rest_id=2').subscribe(res=>
    {
      for(let i= 0; i < res.length; i++){
