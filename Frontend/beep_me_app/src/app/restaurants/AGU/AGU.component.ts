...
@Component({
  templateUrl: './AGU.component.html',
  styleUrls: ['./AGU.component.css']
})


export class AGUComponent implements OnInit {
  ...
  fetchTest():void{ //Mudar rest_id //
    ...
    console.log(this.statesMap.keys())
    console.log(this.statesMap.values())
