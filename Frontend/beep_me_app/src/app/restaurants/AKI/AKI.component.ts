...
export class AKIComponent implements OnInit {
  ...
  fetchRestStamps():void{
    this.httpClient.get<any>('http://deti-engsoft-02.ua.pt:8080/restaurant/orders/perhour').subscribe(res=>
    {
      ...
      for (var value in res.akigrill) {  
         this.map1.set(value,res.akigrill[value])  
      }
  ...
  fetchTest():void{ //Mudar rest_id //
    this.httpClient.get<any>('http://deti-engsoft-02.ua.pt:8080//orders/restaurant?rest_id=14').subscribe(res=>
    {
