...
export class TACComponent implements OnInit {
  ...
  fetchRestStamps():void{
    this.httpClient.get<any>('http://deti-engsoft-02.ua.pt:8080/restaurant/orders/perhour').subscribe(res=>
    {
      ...
      for (var value in res.tacobell) {  
         this.map1.set(value,res.tacobell[value])  
      }
  ...
  fetchTest():void{ //Mudar rest_id //
    this.httpClient.get<any>('http://deti-engsoft-02.ua.pt:8080//orders/restaurant?rest_id=8').subscribe(res=>
    {
